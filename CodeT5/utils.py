    ...
    if os.path.exists(cache_fn) and not is_sample:
        ...
        for task in task_list:
            if task == 'summarize':
                ...
                sub_tasks = ['java-cs', 'cs-java', 't5-java-cs', 't5-cs-java', 't5unique-java-cs', 't5unique-cs-java']
            elif task == 'refine':
...
def get_filenames(data_root, task, sub_task, split=''):
    if task == 'concode':
        ...
        if sub_task == 't5-cs-java':
            train_fn = '{}/train.t5.cs,{}/train.t5.java'.format(data_dir, data_dir)
            dev_fn = '{}/valid.t5.cs,{}/valid.t5.java'.format(data_dir, data_dir)
            test_fn = '{}/test.t5.cs,{}/test.t5.java'.format(data_dir, data_dir)
        elif sub_task == "t5-java-cs":
            train_fn = '{}/train.t5.java,{}/train.t5.cs'.format(data_dir, data_dir)
            dev_fn = '{}/valid.t5.java,{}/valid.t5.cs'.format(data_dir, data_dir)
            test_fn = '{}/test.t5.java,{}/test.t5.cs'.format(data_dir, data_dir)
        elif sub_task == 't5unique-cs-java':
            train_fn = '{}/train.t5unique.cs,{}/train.t5unique.java'.format(data_dir, data_dir)
            dev_fn = '{}/valid.t5unique.cs,{}/valid.t5unique.java'.format(data_dir, data_dir)
            test_fn = '{}/test.t5unique.cs,{}/test.t5unique.java'.format(data_dir, data_dir)
        elif sub_task == "t5unique-java-cs":
            train_fn = '{}/train.t5unique.java,{}/train.t5unique.cs'.format(data_dir, data_dir)
            dev_fn = '{}/valid.t5.java,{}/valid.t5unique.cs'.format(data_dir, data_dir)
            test_fn = '{}/test.t5.java,{}/test.t5unique.cs'.format(data_dir, data_dir)
    elif task == 'clone':
        data_dir = '{}/{}'.format(data_root, task)
